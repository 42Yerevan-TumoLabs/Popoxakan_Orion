...
<div class="profile-header v2">
  ...
  <div class="profile-header-info">
    ...
    <?php
      ...
      $group_types = array_filter($args['group']['group_types'], function ($group_type) use ($vikinger_settings) {
        return $vikinger_settings['group_types'][$group_type]->show_in_list === '1';
      });
