...
<form method="post" action="<?php bbp_wp_login_action( array( 'context' => 'login_post' ) ); ?>" class="bbp-login-form">
    ...
    <legend><?php esc_html_e( 'Log In', 'vikinger' ); ?></legend>
    ...
    <div class="vikinger-forum-topic-form-wrap">
      ...
      <div class="form-item">
        ...
        <div class="form-input small">
          <label for="user_login"><?php esc_html_e( 'Username', 'vikinger' ); ?>: </label>
      ...
      <div class="form-item">
        <!-- FORM INPUT -->
        <div class="form-input small">
          <label for="user_pass"><?php esc_html_e( 'Password', 'vikinger' ); ?>: </label>
      ...
      <div class="form-item">
        ...
        <div class="checkbox-wrap">
          ...
          <label for="rememberme"><?php esc_html_e( 'Keep me signed in', 'vikinger' ); ?></label>
        </div>
        <!-- /CHECKBOX WRAP -->
      </div>
      <!-- /FORM ITEM -->
      ...
      <div class="bbp-submit-wrapper">
        ...
        <button type="submit" name="user-submit" id="user-submit" class="button secondary submit user-submit"><?php esc_html_e( 'Log In', 'vikinger' ); ?></button>
