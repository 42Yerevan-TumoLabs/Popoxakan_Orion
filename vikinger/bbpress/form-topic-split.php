		...
		<div id="split-topic-<?php bbp_topic_id(); ?>" class="bbp-topic-split">
			...
			<form id="split_topic" name="split_topic" method="post">
				...
				<fieldset class="bbp-form">
					...
					<legend><?php printf( esc_html__( 'Split topic "%s"', 'vikinger' ), bbp_get_topic_title() ); ?></legend>
          ...
          <div class="vikinger-forum-topic-form-wrap">
					...
					<div>
						...
						<div class="bbp-template-notice info">
							<ul>
								<li><?php esc_html_e( 'When you split a topic, you are slicing it in half starting with the reply you just selected. Choose to use that reply as a new topic with a new title, or merge those replies into an existing topic.', 'vikinger' ); ?></li>
							</ul>
						</div>

						<div class="bbp-template-notice">
							<ul>
								<li><?php esc_html_e( 'If you use the existing topic option, replies within both topics will be merged chronologically. The order of the merged replies is based on the time and date they were posted.', 'vikinger' ); ?></li>
							</ul>
						</div>

						<fieldset class="bbp-form">
							<legend><?php esc_html_e( 'Split Method', 'vikinger' ); ?></legend>
              ...
              <div class="form-item">
                ...
                <div class="checkbox-wrap">
                  ...
                  <label for="bbp_topic_split_option_reply"><?php printf( esc_html__( 'New topic in %s titled:', 'vikinger' ), bbp_get_forum_title( bbp_get_topic_forum_id( bbp_get_topic_id() ) ) ); ?></label>
                </div>
                <!-- /CHECKBOX WRAP -->
              </div>
              <!-- /FORM ITEM -->
              ...
              <div class="form-item">
                ...
                <div class="form-input small">
                  <input type="text" id="bbp_topic_split_destination_title" value="<?php printf( esc_html__( 'Split: %s', 'vikinger' ), bbp_get_topic_title() ); ?>" size="35" name="bbp_topic_split_destination_title" />
                </div>
                <!-- /FORM INPUT -->
              </div>
              <!-- /FORM ITEM -->
                ...
                <div class="form-item">
                  ...
                  <div class="checkbox-wrap">
                    ...
                    <label for="bbp_topic_split_option_existing"><?php esc_html_e( 'Use an existing topic in this forum:', 'vikinger' ); ?></label>
                  </div>
                  <!-- /CHECKBOX WRAP -->
                </div>
                <!-- /FORM ITEM -->
              ...
              <?php if ( bbp_is_subscriptions_active() ) : ?>
                ...
                <div class="form-item">
                  ...
                  <div class="checkbox-wrap">
                    ...
                    <label for="bbp_topic_subscribers"><?php esc_html_e( 'Copy subscribers to the new topic', 'vikinger' ); ?></label>
                  </div>
                  <!-- /CHECKBOX WRAP -->
                </div>
                <!-- /FORM ITEM -->
              ...
              <?php endif; ?>
                ...
                <div class="form-item">
                  ...
                  <div class="checkbox-wrap">
                    ...
                    <label for="bbp_topic_favoriters"><?php esc_html_e( 'Copy favoriters to the new topic', 'vikinger' ); ?></label>
                  </div>
                  <!-- /CHECKBOX WRAP -->
                </div>
                <!-- /FORM ITEM -->
              ...
              <?php if ( bbp_allow_topic_tags() ) : ?>
                ...
                <div class="form-item">
                  ...
                  <div class="checkbox-wrap">
                    ...
                    <label for="bbp_topic_tags"><?php esc_html_e( 'Copy topic tags to the new topic', 'vikinger' ); ?></label>
                  </div>
                  <!-- /CHECKBOX WRAP -->
                </div>
                <!-- /FORM ITEM -->
