...
<p class="<?php echo pmpro_get_element_class( 'pmpro_actions_nav' ); ?>">
	...
	<a href="<?php echo pmpro_url("account")?>" id="pmpro_levels-return-account"><?php _e('&larr; Return to Your Account', 'vikinger' );?></a>
	<?php else : ?>
	<a href="<?php echo home_url()?>" id="pmpro_levels-return-home"><?php _e('&larr; Return to Home', 'vikinger' );?></a>
	<?php endif; ?>
</p>
<!-- /PMPRO ACTIONS NAV -->